 ...
 */
package tpElisa.AP.Security.Controller;
...
import tpElisa.AP.Security.DTO.JwtDTO;
import tpElisa.AP.Security.DTO.LoginUsuario;
import tpElisa.AP.Security.DTO.NuevoUsuario;
import tpElisa.AP.Security.Entity.Rol;
import tpElisa.AP.Security.Entity.Usuario;
import tpElisa.AP.Security.Enums.RolNombre;
import tpElisa.AP.Security.Service.RolService;
import tpElisa.AP.Security.Service.UsuarioService;
import tpElisa.AP.Security.jwt.JwtProvider;
...
public class AuthController {
    ...
    if (bindingResult.hasErrors())
        return new ResponseEntity(new Mensaje("Inválido"), HttpStatus.BAD_REQUEST);
